export const PERSISTENCE_TYPES = {
    ...
    FederalStateModel: Symbol.for('FederalStateModel'),
    ...
    SamplingStageModel: Symbol.for('SamplingStageModel'),
    OriginModel: Symbol.for('OriginModel'),
    CategoryModel: Symbol.for('CategoryModel'),
    ProductionTypeModel: Symbol.for('ProductionTypeModel'),
    ResistanceModel: Symbol.for('ResistanceModel'),
